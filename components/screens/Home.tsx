...
import { Moon, Sun, ChevronRight, FileText, Clock, Sparkles } from 'lucide-react';
...
export default function Home({ onNavigate, onToggleTheme, isDark }: HomeProps) {
  ...
  const recentCases = [
    { initials: 'M.S.', age: 62, specialty: 'Neurologia', date: '2h', status: 'ready' },
    { initials: 'R.C.', age: 48, specialty: 'Cardiologia', date: 'Ontem', status: 'pending' },
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="px-5 pb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-xs text-sky-600 dark:text-sky-400 font-medium">
            Ver todos
          </button>
        </div>
